          ...
          <div className='contact-page-1 sub-page-body float-start w-100'>
                    ...
                    <div className="container">
                        <div className="row row-cols-1 row-cols-lg-2 g-lg-5 ">
                           <div className="col">
                              ...
                              <p className="text-white"> ISO 31000:2018 is the international standard for Risk Management,
                           ...
                           <div className="col">
                               <figure style={{height:400}} className="mn-big-div need1 ison-sp1">
                                    <Image src="/readingdude.svg" alt="about"
                                    layout="fill"
                                    />
                               </figure>
                           </div>
                ...
                <div className="para-grap-div">
                    <div className="container">
                        ...
                        <h5  className="comon-head-main " style={{marginTop:50}}> benefits of ISO 31000 Certification: </h5>
