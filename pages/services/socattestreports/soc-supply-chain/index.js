...
export default function cybersecurity() {
  return (
    ...
    <meta name="description" content="Accedere is an empanelled SOC Audit Company offers services like SOC Audit, SOC 2 Type 2, AICPA SOC Audit for Supply Chain Logistics in the United States of America, Canada."/>
    <meta name="keywords" content="SOC Audit, SOC 2 Type 2, AICPA SOC Audit for Supply Chain Logistics, Accedere"/>
   </Head>
    <Navbar/>
    <div className='sub-page-body float-start w-100'>
            ...
            <div className="container">
                <div className="row row-cols-1 row-cols-lg-2 g-lg-5">
                   <div className="col">
                       ...
                       <p className="text-white mt-4"> A SOC Audit Report for Supply Chain is intended for use by those who have sufficient knowledge and understanding of the entity, the products it produces, manufactures, and distributors, and the system that produces, manufactures, or distributes them. The expected knowledge of
                        intended users ordinarily includes the following:</p>
                   ...
                   <div className="col">
                       <figure style={{height:750}} className="comon-banner-img ison-sp1">
                          <Image src="/realtime.svg"
                          layout="fill"/>
                       </figure>
                   </div>
                </div>
         ...
         <div className="para-grap-div">
               <div className="container">
                  ...
                  <div className="row row-cols-1 row-cols-lg-2 g-lg-5 mt-0">
                     ...
                     <div className="col">
                              <figure style={{height:450}} className="comon-sub-main2 ison-sp1">
                                 <Image src="/people.svg" alt="about"
                                 layout="fill"
                                 />
                           </figure>
                     </div>
         ...
         <div  className="middle-part-div py-5">
             <div style={{fontWeight:"bold",fontSize:25}} className="container">
                 <p className="text-center  mx-auto"> This is why supply chain risk management has become such a significant issue to many organizations and their
         ...
         <div className="comon-next-gray-bg py-5">
            <div className="container">
               <div className="row row-cols-1 row-cols-lg-2 g-lg-5">
                     ...
                     <div className="col">
                        <figure style={{height:400}} className="right-img-nm">
                            <Image src="/AdobeStock_257556825.svg"
                            layout="fill"/>
                        </figure>
                    </div>
                    <div className="col">
