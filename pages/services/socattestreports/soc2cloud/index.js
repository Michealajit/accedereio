          ...
          <div className='contact-page-1 sub-page-body float-start w-100'>
                ...
                <div className="top-seco-sec comon-top-space">
                    <div className="container">
                        <div style={{marginBottom:80}} className="row row-cols-1 row-cols-lg-2 g-lg-5">
                           <div className="col">
                              <h2 className="comon-head-main text-white"> SOC 2 Compliance For CSA STAR </h2>
                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-7 ps-lg-5">
                                <h2 className="comon-head-main mt-5 mt-lg-0"> Security Responsibilities in Cloud </h2>
                                <p  > At a high level, security responsibility maps to the degree of control any given 
