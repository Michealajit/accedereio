                    ...
                    <div className="col">
                      <Link href="/services/socattestreports/soc-2-type-2-compliance-audit">
                          <div className="comon-services-part">
                               ...
                               <p>One of the most important reports for third party (vendor) data security and SOX compliance is the SOC 2 Type 2 Audit.
                               </p> 
                               <span className="btn"> read more <FaAngleRight/> </span>
                          </div>
                      </Link>
                    ...
                    <div className="col">
                      <Link href="/services/socattestreports/soc2cloud">
                          <div className="comon-services-part">
                               ...
                               <p>Being a CPA firm, we can provide you SOC Attestation Reports + CCM from CSA to achieve the STAR Level 1/2 compliance.
                               </p> 
                               <span className="btn"> read more <FaAngleRight/> </span>
                          </div>
                      </Link>
                    ...
                    <div className="col">
                        <Link href="/services/socattestreports/soc2privacy">
                            <div className="comon-services-part">
                                ...
                                <p>SOC 2 uses the AICPA Trust Services Criteria (TSC) for Privacy Category.
                                </p> 
                                <span className="btn"> read more <FaAngleRight/> </span>
                            </div>
                        </Link>
                    ...
                    <div className="col">
                      <Link href="/services/socattestreports/soc4cyber">
                          <div className="comon-services-part">
                               ...
                               <p>A SOC 2 Cybersecurity Risk Management Examination usually addresses an entity-wide program or a portion of it.
                               </p> 
                               <span className="btn"> read more <FaAngleRight/> </span>
                          </div>
                      </Link>
                    ...
                    <div className="col">
                      <Link href="/services/socattestreports/soc-supply-chain">
                          <div className="comon-services-part">
                              ...
                              <p>A SOC Audit Report for Supply Chain is intended for use by those who have sufficient knowledge and understanding of the entire entity and its system.
                              </p> 
                              <span className="btn"> read more <FaAngleRight/> </span>
                          </div>
                      </Link>
