         ...
         <div className="comon-top-space">
            <div className="container">
                <div className="row row-cols-1 row-cols-md-2 g-lg-5">
                   <div className="col">
                       <h2 style={{marginTop:40}} className="text-white comon-head-main mt-0"> 
                       SEBI Directive Audit </h2>

                       <p style={{marginTop:30}} className="text-white"> SEBI (Securities and Exchange Board of India) regulates the securities 
