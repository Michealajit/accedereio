            ...
            <div className="container">
                <div className="row row-cols-1 row-cols-md-2 g-lg-5">
                   <div className="col">
                       ...
                       <p className="text-white"> Over the past years, It has become imperative for Banks
                       ...
                       <p className="text-white"> Since we&apos;re CERT-In empaneled auditors, our team has the relevant
                        experience and expertise to help you. We can conduct audits of your Banks IT Infrastructure 
         ...
         <div className="comon-inside-services py-5">
            <div className="container">
                ...
                <div className="row row-cols-1 row-cols-sm-2 indian-se-div row-cols-lg-2 gy-5 gy-lg-5 mt-0 justify-content-center">
                    <div className="col">
                        <figure style={{height:820,marginLeft:-10}} className="comon-banner-img ison-sp1">
                            <Image src="/modernprofessional.svg"
                            layout="fill"/>
                        </figure>
                    </div>
                    <div className="col">
                    ...
                    <h5 style={{fontWeight:"bold",fontSize:30}}> We can help you with complete guidance to stay compliant with RBI&apos;s guidelines 
