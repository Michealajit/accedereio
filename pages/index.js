...
import HomeClientLogo from '.././componets/HomeClientLogo'
...
export default function Home() {
  return (
    ...
    <Head>
        ...
        <meta name="description" content="Accedere is Cybersecurity Audits and Assessments firm with a major focus on AICPA SOC 1, 2,3 Compliance Reports, ISO/IEC Audits for Data Security & Privacy, Cloud Security."/>
