...
function Clientlogo(){
    ...
    return(
        <>
          <div style={{width:"100%"}} className="client-logo-div-slide py-5">
             <div   className="container">
                  <h2 style={{fontSize:40}} className="comon-head-main text-center blue-color"> Trusted By Many Leading Cloud Service Providers  </h2>
                   <div style={{padding:5}} className="client-logo-div-sec mt-5">
