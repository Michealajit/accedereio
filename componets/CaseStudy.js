                    ...
                    <div className="row row-cols-1 row-cols-lg-4 gy-5 g-lg-4 mt-0 mt-lg-5">
                        ...
                        <div className="col">
                                    ...
                                    <div className="case-styudies-div">
                                        ...
                                        <figure className="mt-4 case-st-img">
                                            <Image src="/pexels-photo-3183186.svg" alt="st1" 
                                            layout="fill" />
                                        </figure>
                        ...
                        <div className="col">
                                    ...
                                    <div className="case-styudies-div">
                                        ...
                                        <figure className="mt-4 case-st-img">
                                            <Image src="/ad-comon1.svg" alt="st1" 
                                            layout="fill" />
                                        </figure>
                        ...
                        <div className="col">
                                    ...
                                    <div className="case-styudies-div">
                                        <h6> white paper </h6>
                                        <h4> <Link href="/"> ISO Certification Services </Link> </h4>
                                        ...
                                        <figure className="mt-4 case-st-img">
                                            <Image src="/AdobeStock_257556825.svg" alt="st1" 
                                            layout="fill" />
                                        </figure>
