                ...
                <div className="container">
                   <div className="row row-cols-1 row-cols-lg-4 align-items-start">
                      <div className="col">
                          ...
                          <h5 className="text-white mt-4">  USA   </h5>
                          <p className="col-lg-10">999, 18th St,
                          #3000, Denver,
                          Colorado 80202.</p> 
                          <h5 className="text-white"> India </h5>
                          <p className="col-lg-10">115B Andheri Industrial Estate, Off Veera Desai Road,
                          Andheri West Mumbai, 400053.</p> 
                          
                      </div>
                      <div className="col ">
                         <Services className="comon-footer-s mt-4 mt-lg-0">
                      ...
                      <div className="col d-lg-grid justify-content-lg-center">
                          <CompanyDiv className="comon-footer-s mt-4 mt-lg-0">
                   ...
                   <div style={{paddingTop:10}} className="d-md-flex align-items-center justify-content-between  mt-3 mb-3">
