        ...
        <div className={scroll ? "bg-black" : "bg-white"}>
            ...
            <div className="container">
                ...
                <a className='logo-div' data-bs-toggle="tooltip" data-bs-placement="top" title='Trusted By Many Leading Cloud Service Providers '>
                   ...
                   <div  style={{marginTop:-50,overflow:"hidden",height:105}} className='color-logo'>
                        <Image  
                        src="/Accedere Blue Logos.svg"
                        alt="Picture of the author"
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li >
                            <Link href='https://www.freebird.aero/#1' > 
                                <span className="nav-link"> Drones</span>
                            </Link>
                        </li>
